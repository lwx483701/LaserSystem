...
CCheckSK::CCheckSK()
{
    ...
    m_colLedOn  = RGB(255, 0, 150);
    m_colLedOff = RGB(0,   155, 155);
...
//  ===========================================================================
void CCheckSK::SetCheck(BOOL bCheck, BOOL bRepaint)
{
    m_bCheck = bCheck;
...
//  ===========================================================================
DWORD CCheckSK::SetIcon(int nIconOn, int nIconOff)
{
    HICON       hIconOn         = NULL;
    HICON       hIconOff        = NULL;
...
//  Set Icon from file
//  ===========================================================================
DWORD CCheckSK::SetIcon(LPCTSTR lpszFileNameIn, LPCTSTR lpszFileNameOut)
{
    HICON hIconOn   = NULL;
    HICON hIconOff  = NULL;
...
//  ===========================================================================
DWORD CCheckSK::SetIcon(HICON hIconOn, HICON hIconOff)
{
    BOOL      bRetValue;
    ICONINFO  ii;
...
void CCheckSK::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
    ...
    if ( m_bMouseOver )
    {
        brushForeGnd.CreateSolidBrush (::GetSysColor(COLOR_3DFACE));//COLOR_BTNHILIGHT
    ...
    //  .......................................................................
//    if (m_bIsFocussed)    //5.31
//        pDC->DrawFocusRect(&rectItem);  //5.31
...
void CCheckSK::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
BOOL CCheckSK::SetLedSize(int nSize)
{
    if (nSize < 0)
        return FALSE;
    else
...
BOOL CCheckSK::SetLedColor(COLORREF colLedOn, COLORREF colLedOff)
{
    m_colLedOn  = colLedOn;
...
void CCheckSK::SetToolTip(LPCTSTR lpszText)
{
    if (!lpszText)
        return;
