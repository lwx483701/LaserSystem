...
/////////////////////////////////////////////////////////////////////////////
// CListEditCtrl
BEGIN_MESSAGE_MAP(CListEditCtrl, CSmartEdit)
...
{
	if (CSmartEdit::OnCreate(lpCreateStruct) == -1)		
		return -1;	
...
BOOL CListEditCtrl::PreTranslateMessage(MSG* pMsg)
{
	...
	return CSmartEdit::PreTranslateMessage(pMsg);
}


void CListEditCtrl::OnKillFocus(CWnd* pNewWnd)
{	
	CSmartEdit::OnKillFocus(pNewWnd);
