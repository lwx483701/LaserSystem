...
// letting me know that you are us	ing it would be nice as well. That's 
...
// Implementation
public:
	void SetEditRange(long lMax,long lMin);
	void SetEditParseType(WORD type);
    virtual ~CGridCtrl();
protected:
...
protected:
    ...
    virtual void  CreateInPlaceEditControl(CRect& rect, DWORD dwStyle, WORD type,UINT nID,
                                           int nRow, int nCol,
