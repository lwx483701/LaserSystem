...
//	friend CAdoConnection& GetAdoConnectionCal();
//	friend CAdoConnection& GetAdoConnectionPro();
//	friend CAdoConnection& GetAdoConnectionPow();
//	friend CAdoConnection& GetAdoConnectionPowPara();
};
