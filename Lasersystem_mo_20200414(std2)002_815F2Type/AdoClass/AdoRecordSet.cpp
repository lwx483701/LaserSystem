...
/*
CAdoRecordSet& GetCalcSet()
{
	static CAdoRecordSet  CordSet;
	return CordSet;
}
CAdoRecordSet& GetProSet()
 {
	static CAdoRecordSet  ErrSet;
	return ErrSet;
}

CAdoRecordSet& GetPowerSet()
 {
	static CAdoRecordSet  PowerSet;
	return PowerSet;
}

CAdoRecordSet& GetPowerParaSet()
 {
	static CAdoRecordSet  PowerParaSet;
	return PowerParaSet;
}
*/
CAdoRecordSet::CAdoRecordSet()
{
	...
	if (m_pRecordset == NULL)
	{
		...
		strncpy(ez ,GetLang().GetWarningText(14023),256);
		AfxMessageBox(ez);//"RecordSet 对象创建失败! 请确认是否初始化了COM环境."
	}
	#endif
...
BOOL CAdoRecordSet::Open(LPCTSTR strSQL, long lOption, CursorTypeEnum CursorType, LockTypeEnum LockType)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14058),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: 打开记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		TRACE(_T("%s\r\n"), GetLastError());
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Requery(long Options)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14059),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Requery 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Resync(AffectEnum AffectRecords, ResyncEnum ResyncValues)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14060),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Resync 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Save(LPCTSTR strFileName, PersistFormatEnum PersistFormat)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14061),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Save 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Load(LPCTSTR strFileName)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14062),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Load 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Cancel()
{
	...
	catch (_com_error e)
	{
		...
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Cancel发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
void CAdoRecordSet::Close()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14063),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: 关闭记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
	}
}
...
BOOL CAdoRecordSet::AddNew()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14064),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: AddNew 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::Update()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14065),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Update 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
...
BOOL CAdoRecordSet::UpdateBatch(AffectEnum AffectRecords)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14066),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: UpdateBatch 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::CancelUpdate()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14067),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: CancelUpdate 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::CancelBatch(AffectEnum AffectRecords)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14068),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: CancelBatch 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Delete(AffectEnum AffectRecords)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14069),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Delete发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveFirst()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14070),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: MoveFirst 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveLast()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14071),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: MoveLast 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MovePrevious()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14072),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: MovePrevious 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
	return FALSE;	
}
...
BOOL CAdoRecordSet::MoveNext()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14073),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: MoveNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Move(long lRecords, _variant_t Start)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14074),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Move 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::IsOpen()
{
	...
	catch (_com_error e)
	{
		...
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: IsOpen方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
long CAdoRecordSet::GetStatus()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14076),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetStatus 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	} 
	return -1;
}
...
long CAdoRecordSet::GetRecordCount()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14077),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	} 
}
...
long CAdoRecordSet::GetFieldsCount()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14078),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetFieldsCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	} 
}
/*========================================================================
...
long CAdoRecordSet::GetMaxRecordCount()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14079),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetMaxRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
BOOL CAdoRecordSet::IsBOF()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14080),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: IsBOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::IsEOF()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14081),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: IsEOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
long CAdoRecordSet::GetPageCount()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14082),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetPageCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCacheSize(const long &lCacheSize)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14083),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetCacheSize方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
	return TRUE;
}
...
long CAdoRecordSet::GetPageSize()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14084),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetPageSize方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetAbsolutePage(int nPage)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14085),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePage()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14086),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetAbsolutePosition(int nPosition)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14087),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePosition()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14088),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCursorLocation(CursorLocationEnum CursorLocation)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14089),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: PutCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
CursorLocationEnum CAdoRecordSet::GetCursorLocation()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14090),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return adUseNone;
	}
}
...
BOOL CAdoRecordSet::SetCursorType(CursorTypeEnum CursorType)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14091),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
CursorTypeEnum CAdoRecordSet::GetCursorType()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14092),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
...
FieldsPtr CAdoRecordSet::GetFields()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14093),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetFields 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return NULL;
	} 
	return NULL;
}
...
CString CAdoRecordSet::GetFieldName(long lIndex)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14094),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetFieldName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
	}
	return strFieldName;
}
...
long CAdoRecordSet::GetFieldAttributes(long lIndex)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14095),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetFieldAttributes 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldDefineSize(long lIndex)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14096),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetDefineSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldActualSize(long lIndex)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14097),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetFieldActualSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return -1;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(long lIndex)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14075),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetField 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return adEmpty;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(LPCTSTR lpszFieldName)
{
	...
	catch (_com_error e)
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14075),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetField发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return adEmpty;
	}	
}
...
BOOL CAdoRecordSet::IsFieldNull(LPCTSTR lpFieldName)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14098),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: IsFieldNull 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::PutCollect(long index, const _variant_t &value)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14099),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: PutCollect 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::PutCollect(long index, const bool &value)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14112),256);
		TRACE(_T(ez), __FILE__, __LINE__);//"Warning: 你要存贮的字段与变量的数据类型不符; 文件: %s; 行: %d\n"
	}
	#endif
...
BOOL CAdoRecordSet::GetCollect(long index,  DWORD &value)
{
	...
	try
	{
		...
		default:
			{char ez[256]={""};//ly 20110405
			strncpy(ez ,GetLang().GetWarningText(14113),256);
			TRACE(_T(ez), __FILE__, __LINE__);//"Warning: 无法读取相应的字段, 数据类型不匹配; 文件: %s; 行: %d\n"
			return FALSE;}
		}		
		return TRUE;
	}
...
BOOL CAdoRecordSet::GetCollect(long index, CString& strValue)
{
	...
	try
	{
		...
		{//提示
			char ez[256]={""};//ly 20110405
			strncpy(ez ,GetLang().GetWarningText(14024),256);
			MessageBox(NULL, _T(ez), _T("Info"), MB_ICONINFORMATION);//"数据库可能已经断开,\r\n请重新连接、然后重试."
			return FALSE;
		} 
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14100),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: 字段访问失败. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
...
BOOL CAdoRecordSet::AppendChunk(FieldPtr pField, LPVOID lpData, UINT nBytes)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14101),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: AppendChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::GetChunk(FieldPtr pField, LPVOID lpData)
{
	...
	{ 
		...
		{
			char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14102),256);
			TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
			return FALSE;
		}
	}
...
BOOL CAdoRecordSet::Supports(CursorOptionEnum CursorOptions)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14103),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Supports方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::SetFilter(LPCTSTR lpszFilter)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14104),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetFilter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
_variant_t CAdoRecordSet::GetBookmark()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14105),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: GetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
	}
...
BOOL CAdoRecordSet::SetBookmark(_variant_t varBookMark)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14106),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: SetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Clone(CAdoRecordSet &pRecordSet)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14107),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Clone 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Find(LPCTSTR lpszFind, SearchDirectionEnum SearchDirection)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14108),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: Find 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::FindNext()
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14109),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: FindNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::RecordBinding(CADORecordBinding &pAdoRecordBinding)
{
	...
	{
		char ez[256]={""};//ly 20110405
		strncpy(ez ,GetLang().GetWarningText(14110),256);
		TRACE(_T(ez), e.ErrorMessage(), __FILE__, __LINE__);//"Warning: RecordBinding 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"
		return FALSE;
	}
}
