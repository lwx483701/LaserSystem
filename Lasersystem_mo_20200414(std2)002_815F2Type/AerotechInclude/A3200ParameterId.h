...
typedef enum {
	...
	PARAMETERID_IFOVConfigurations = ( (2 << 24) | 263 ),
	/// \brief The IFOVMaximumTime parameter
	PARAMETERID_IFOVMaximumTime = ( (2 << 24) | 264 ),
	/// \brief The SignalLogItems parameter
	PARAMETERID_SignalLogItems = ( (2 << 24) | 265 ),
	...
	PARAMETERID_MaxRetraceMoves = ( (1 << 24) | 170 ),
	...
	PARAMETERID_PiezoVoltsPerUnit = ( (0 << 24) | 386 ),
	/// \brief The PiezoVoltageClampLow parameter
	PARAMETERID_PiezoVoltageClampLow = ( (0 << 24) | 387 ),
	/// \brief The PiezoVoltageClampHigh parameter
	PARAMETERID_PiezoVoltageClampHigh = ( (0 << 24) | 388 ),
	/// \brief The PiezoSlewRateClamp parameter
	PARAMETERID_PiezoSlewRateClamp = ( (0 << 24) | 389 ),
	/// \brief The PiezoDefaultServoState parameter
	PARAMETERID_PiezoDefaultServoState = ( (0 << 24) | 390 ),
	/// \brief The FeedforwardAdvance parameter
	PARAMETERID_FeedforwardAdvance = ( (0 << 24) | 391 ),
	/// \brief The CapSensorSetup parameter
	PARAMETERID_CapSensorSetup = ( (0 << 24) | 392 ),
	/// \brief The CapSensorThresholdLow parameter
	PARAMETERID_CapSensorThresholdLow = ( (0 << 24) | 393 ),
	/// \brief The CapSensorThresholdHigh parameter
	PARAMETERID_CapSensorThresholdHigh = ( (0 << 24) | 394 ),
	/// \brief The GainJff parameter
	PARAMETERID_GainJff = ( (0 << 24) | 395 ),
	/// \brief The RequiredStageSerialNumber parameter
	PARAMETERID_RequiredStageSerialNumber = ( (0 << 24) | 396 ),
	/// \brief The CurrentLoopSetup parameter
	PARAMETERID_CurrentLoopSetup = ( (0 << 24) | 399 ),
	/// \brief The TorqueAngleOffset parameter
	PARAMETERID_TorqueAngleOffset = ( (0 << 24) | 400 ),
	/// \brief The AuxiliaryEmulatedQuadratureDivider parameter
	PARAMETERID_AuxiliaryEmulatedQuadratureDivider = ( (0 << 24) | 401 ),
	/// \brief The AuxiliaryEncoderCosineGain parameter
	PARAMETERID_AuxiliaryEncoderCosineGain = ( (0 << 24) | 402 ),
	/// \brief The AuxiliaryEncoderCosineOffset parameter
	PARAMETERID_AuxiliaryEncoderCosineOffset = ( (0 << 24) | 403 ),
	/// \brief The AuxiliaryEncoderMarkerAlignment parameter
	PARAMETERID_AuxiliaryEncoderMarkerAlignment = ( (0 << 24) | 404 ),
	/// \brief The AuxiliaryEncoderMultiplicationFactor parameter
	PARAMETERID_AuxiliaryEncoderMultiplicationFactor = ( (0 << 24) | 405 ),
	/// \brief The AuxiliaryEncoderMultiplierSetup parameter
	PARAMETERID_AuxiliaryEncoderMultiplierSetup = ( (0 << 24) | 406 ),
	/// \brief The AuxiliaryEncoderPhase parameter
	PARAMETERID_AuxiliaryEncoderPhase = ( (0 << 24) | 407 ),
	/// \brief The AuxiliaryEncoderSineGain parameter
	PARAMETERID_AuxiliaryEncoderSineGain = ( (0 << 24) | 408 ),
	/// \brief The AuxiliaryEncoderSineOffset parameter
	PARAMETERID_AuxiliaryEncoderSineOffset = ( (0 << 24) | 409 ),
	/// \brief The AuxiliaryEncoderRadiusThresholdLow parameter
	PARAMETERID_AuxiliaryEncoderRadiusThresholdLow = ( (0 << 24) | 410 ),
	/// \brief The AuxiliaryEncoderRadiusThresholdHigh parameter
	PARAMETERID_AuxiliaryEncoderRadiusThresholdHigh = ( (0 << 24) | 411 ),
	/// \brief The StepperDampingGain parameter
	PARAMETERID_StepperDampingGain = ( (0 << 24) | 412 ),
	/// \brief The StepperDampingCutoffFrequency parameter
	PARAMETERID_StepperDampingCutoffFrequency = ( (0 << 24) | 413 ),
	/// \brief The ServoFilter8CoeffN0 parameter
	PARAMETERID_ServoFilter8CoeffN0 = ( (0 << 24) | 414 ),
	/// \brief The ServoFilter8CoeffN1 parameter
	PARAMETERID_ServoFilter8CoeffN1 = ( (0 << 24) | 415 ),
	/// \brief The ServoFilter8CoeffN2 parameter
	PARAMETERID_ServoFilter8CoeffN2 = ( (0 << 24) | 416 ),
	/// \brief The ServoFilter8CoeffD1 parameter
	PARAMETERID_ServoFilter8CoeffD1 = ( (0 << 24) | 417 ),
	/// \brief The ServoFilter8CoeffD2 parameter
	PARAMETERID_ServoFilter8CoeffD2 = ( (0 << 24) | 418 ),
	/// \brief The ServoFilter9CoeffN0 parameter
	PARAMETERID_ServoFilter9CoeffN0 = ( (0 << 24) | 419 ),
	/// \brief The ServoFilter9CoeffN1 parameter
	PARAMETERID_ServoFilter9CoeffN1 = ( (0 << 24) | 420 ),
	/// \brief The ServoFilter9CoeffN2 parameter
	PARAMETERID_ServoFilter9CoeffN2 = ( (0 << 24) | 421 ),
	/// \brief The ServoFilter9CoeffD1 parameter
	PARAMETERID_ServoFilter9CoeffD1 = ( (0 << 24) | 422 ),
	/// \brief The ServoFilter9CoeffD2 parameter
	PARAMETERID_ServoFilter9CoeffD2 = ( (0 << 24) | 423 ),
	/// \brief The ServoFilter10CoeffN0 parameter
	PARAMETERID_ServoFilter10CoeffN0 = ( (0 << 24) | 424 ),
	/// \brief The ServoFilter10CoeffN1 parameter
	PARAMETERID_ServoFilter10CoeffN1 = ( (0 << 24) | 425 ),
	/// \brief The ServoFilter10CoeffN2 parameter
	PARAMETERID_ServoFilter10CoeffN2 = ( (0 << 24) | 426 ),
	/// \brief The ServoFilter10CoeffD1 parameter
	PARAMETERID_ServoFilter10CoeffD1 = ( (0 << 24) | 427 ),
	/// \brief The ServoFilter10CoeffD2 parameter
	PARAMETERID_ServoFilter10CoeffD2 = ( (0 << 24) | 428 ),
	/// \brief The ServoFilter11CoeffN0 parameter
	PARAMETERID_ServoFilter11CoeffN0 = ( (0 << 24) | 429 ),
	/// \brief The ServoFilter11CoeffN1 parameter
	PARAMETERID_ServoFilter11CoeffN1 = ( (0 << 24) | 430 ),
	/// \brief The ServoFilter11CoeffN2 parameter
	PARAMETERID_ServoFilter11CoeffN2 = ( (0 << 24) | 431 ),
	/// \brief The ServoFilter11CoeffD1 parameter
	PARAMETERID_ServoFilter11CoeffD1 = ( (0 << 24) | 432 ),
	/// \brief The ServoFilter11CoeffD2 parameter
	PARAMETERID_ServoFilter11CoeffD2 = ( (0 << 24) | 433 ),
	/// \brief The ServoFilter12CoeffN0 parameter
	PARAMETERID_ServoFilter12CoeffN0 = ( (0 << 24) | 434 ),
	/// \brief The ServoFilter12CoeffN1 parameter
	PARAMETERID_ServoFilter12CoeffN1 = ( (0 << 24) | 435 ),
	/// \brief The ServoFilter12CoeffN2 parameter
	PARAMETERID_ServoFilter12CoeffN2 = ( (0 << 24) | 436 ),
	/// \brief The ServoFilter12CoeffD1 parameter
	PARAMETERID_ServoFilter12CoeffD1 = ( (0 << 24) | 437 ),
	/// \brief The ServoFilter12CoeffD2 parameter
	PARAMETERID_ServoFilter12CoeffD2 = ( (0 << 24) | 438 ),
	/// \brief The ServoFilter13CoeffN0 parameter
	PARAMETERID_ServoFilter13CoeffN0 = ( (0 << 24) | 439 ),
	/// \brief The ServoFilter13CoeffN1 parameter
	PARAMETERID_ServoFilter13CoeffN1 = ( (0 << 24) | 440 ),
	/// \brief The ServoFilter13CoeffN2 parameter
	PARAMETERID_ServoFilter13CoeffN2 = ( (0 << 24) | 441 ),
	/// \brief The ServoFilter13CoeffD1 parameter
	PARAMETERID_ServoFilter13CoeffD1 = ( (0 << 24) | 442 ),
	/// \brief The ServoFilter13CoeffD2 parameter
	PARAMETERID_ServoFilter13CoeffD2 = ( (0 << 24) | 443 ),
	/// \brief The ServoFilter14CoeffN0 parameter
	PARAMETERID_ServoFilter14CoeffN0 = ( (0 << 24) | 444 ),
	/// \brief The ServoFilter14CoeffN1 parameter
	PARAMETERID_ServoFilter14CoeffN1 = ( (0 << 24) | 445 ),
	/// \brief The ServoFilter14CoeffN2 parameter
	PARAMETERID_ServoFilter14CoeffN2 = ( (0 << 24) | 446 ),
	/// \brief The ServoFilter14CoeffD1 parameter
	PARAMETERID_ServoFilter14CoeffD1 = ( (0 << 24) | 447 ),
	/// \brief The ServoFilter14CoeffD2 parameter
	PARAMETERID_ServoFilter14CoeffD2 = ( (0 << 24) | 448 ),
	/// \brief The ServoFilter15CoeffN0 parameter
	PARAMETERID_ServoFilter15CoeffN0 = ( (0 << 24) | 449 ),
	/// \brief The ServoFilter15CoeffN1 parameter
	PARAMETERID_ServoFilter15CoeffN1 = ( (0 << 24) | 450 ),
	/// \brief The ServoFilter15CoeffN2 parameter
	PARAMETERID_ServoFilter15CoeffN2 = ( (0 << 24) | 451 ),
	/// \brief The ServoFilter15CoeffD1 parameter
	PARAMETERID_ServoFilter15CoeffD1 = ( (0 << 24) | 452 ),
	/// \brief The ServoFilter15CoeffD2 parameter
	PARAMETERID_ServoFilter15CoeffD2 = ( (0 << 24) | 453 ),
	/// \brief The AutoMsetRampTime parameter
	PARAMETERID_AutoMsetRampTime = ( (0 << 24) | 454 ),
	/// \brief The AutoMsetAngle parameter
	PARAMETERID_AutoMsetAngle = ( (0 << 24) | 455 ),
	/// \brief The STOPulseFilter parameter
	PARAMETERID_STOPulseFilter = ( (0 << 24) | 456 ),
} PARAMETERID;
